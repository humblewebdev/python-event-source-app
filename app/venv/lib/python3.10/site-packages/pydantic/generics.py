...
# E.g., for generic models `Model[A, B]`, when parametrized models `Model[int, str]` is created,
...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        :param params: Tuple of types the class . Given a generic class
            `Model` with 2 type variables and a concrete models `Model[str, int]`,
            the value `(str, int)` would be passed to `params`.
        :return: New models class inheriting from `cls` with instantiated
        ...
        if cls.__concrete__ and Generic not in cls.__bases__:
            raise TypeError('Cannot parameterize a concrete instantiation of a generic models')
        ...
        # Create new models with original models as parent inserting fields with DeferredType.
        ...
        # Find any typevars that are still present in the models.
        # If none are left, the models is fully "concrete", otherwise the new
        ...
        # Save created models in cache so we don't end up creating duplicate
    ...
    def __parameterized_bases__(cls, typevars_map: Parametrization) -> Iterator[Type[Any]]:
        ...
        :param typevars_map: Dictionary of type applications for binding subclasses.
            ...
            and a concrete models `Model[str, int]`,
        ...
        for base_model in cls.__bases__:
            if not issubclass(base_model, GenericModel):
                ...
                # can construct the Parameterised base models using typevars_map directly
