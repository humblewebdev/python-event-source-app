...
def validator(
    *fields: str,
    ...
    :param check_fields: whether to check that the fields actually exist on the models
...
def root_validator(
    ...
    """
    Decorate methods on a models indicating that they should be used to validate (and perhaps modify) data either
    before or after standard models parsing/validation is performed.
    """
    if _func:
    ...
    def check_for_unused(self) -> None:
        ...
        if unused_validators:
            ...
            raise ConfigError(
                ...
                f"(use check_fields=False if you're inheriting from the models and intended this)"
            )
