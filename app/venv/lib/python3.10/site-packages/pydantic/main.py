...
# When creating a `BaseModel` instance, we bypass all the methods, properties... added to the models
...
class ModelMetaclass(ABCMeta):
    ...
    def __new__(mcs, name, bases, namespace, **kwargs):  # noqa C901
        ...
        # set __signature__ attr only for models class, but not for its instances
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def __init__(__pydantic_self__, **data: Any) -> None:
        """
        Create a new models by parsing and validating input data from keyword arguments.

        Raises ValidationError if the input data cannot be parsed to form a valid models.
        """
    ...
    def dict(
        ...
        *,
        ...
        """
        Generate a dictionary representation of the models, optionally specifying which fields to include or exclude.
    ...
    def json(
        ...
        **dumps_kwargs: Any,
        ...
        """
        Generate a JSON representation of the models, `include` and `exclude` arguments as per `dict()`.
    ...
    def construct(cls: Type['Model'], _fields_set: Optional['SetStr'] = None, **values: Any) -> 'Model':
        """
        Creates a new models setting __dict__ and __fields_set__ from trusted or pre-validated data.
    ...
    def copy(
        ...
        *,
        ...
        """
        Duplicate a models, optionally choose which fields to include, exclude and change.

        :param include: fields to include in new models
        :param exclude: fields to exclude from new models, as with values this takes precedence over include
        :param update: values to change/add in the new models. Note: the data is not validated before creating
            the new models: you should trust this data
        :param deep: set to `True` to make a deep copy of the models
    ...
    def validate(cls: Type['Model'], value: Any) -> 'Model':
        if isinstance(value, cls):
            ...
            # whether to deep or shallow copy the models on validation, None means do not copy
...
def create_model(
    ...
    **field_definitions: Any,
    ...
    """
    Dynamically create a models.
    :param __model_name: name of the created models
    :param __config__: config class to use for the new models
    :param __base__: base class for the new models to inherit from
    :param __module__: module of the created models
    :param __validators__: a dict of method names and @validator class methods
    :param __cls_kwargs__: a dict for class creation
    :param __slots__: Deprecated, `__slots__` should not be passed to `create_model`
    :param field_definitions: fields of the models (or extra fields if a base is supplied)
...
def validate_model(  # noqa: C901 (ignore complexity)
    ...
    """
    validate data against a models.
    """
    values = {}
    errors = []
