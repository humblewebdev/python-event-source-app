...
if not compiled:
    ...
    class ConfigDict(TypedDict, total=False):
        ...
        # whether or not inherited models as fields should be reconstructed as base models
...
class BaseConfig:
    ...
    # whether inherited models as fields should be reconstructed as base models,
    ...
    def prepare_field(cls, field: 'ModelField') -> None:
        """
        Optional hook to check or modify fields during models creation.
        """
        pass
