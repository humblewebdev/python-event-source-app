...
def Field(
    ...
    **extra: Any,
    ...
    """
    Used to provide extra information about a field, either for the models schema or complex validation. Some arguments
...
class ModelField(Representation):
    ...
    def _get_field_info(
        ...
        :param config: the models's config object
    ...
    def prepare(self) -> None:
        ...
        if self.type_.__class__ is ForwardRef or self.type_.__class__ is DeferredType:
            ...
            # user will need to call models.update_forward_refs()
            return
...
def PrivateAttr(
    ...
    *,
    ...
    Private attrs are stored in models __slots__.
