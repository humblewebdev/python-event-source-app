...
class PydanticModelTransformer:
    ...
    def transform(self) -> None:
        ...
        In particular:
        * determines the models config and fields,
    ...
    def collect_fields(self, model_config: 'ModelConfigData') -> List['PydanticModelField']:
        """
        Collects the fields for the models, accounting for parent classes
        """
    ...
    def is_dynamic_alias_present(fields: List['PydanticModelField'], has_alias_generator: bool) -> bool:
        """
        Returns whether any fields on the models have a "dynamic alias", i.e., an alias that cannot be
