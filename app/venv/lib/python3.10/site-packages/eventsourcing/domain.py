...
class AggregateEvent(CanMutateAggregate, DomainEvent):
    """
    Base class for aggregate events. Subclasses will models
    decisions made by the domain models aggregates.
    """
...
class ProgrammingError(EventSourcingError):
    """
    Exception class for domain models programming errors.
    """
